...
proc cr_bd_$::_xil_proj_name_ { parentCell } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.PSU__CRL_APB__PL0_REF_CTRL__ACT_FREQMHZ {80.000000} \
  ...
  connect_bd_intf_net -intf_net aiml_stub_0_m_axi_data_mem [get_bd_intf_pins aiml_stub_0/m_axi_data_mem] [get_bd_intf_pins axi_smc/S00_AXI]
  ...
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins aiml_stub_0/ap_rst_n] [get_bd_pins axi_smc/aresetn] [get_bd_pins proc_sys_reset_0/peripheral_aresetn] [get_bd_pins smartconnect_0/aresetn]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins aiml_stub_0/ap_clk] [get_bd_pins axi_smc/aclk] [get_bd_pins proc_sys_reset_0/slowest_sync_clk] [get_bd_pins smartconnect_0/aclk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/pl_clk0] [get_bd_pins zynq_ultra_ps_e_0/saxihpc0_fpd_aclk]
  ...
  assign_bd_address -offset 0xA0000000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs aiml_stub_0/s_axi_cfg_port1/Reg] -force
  ...
  exclude_bd_addr_seg -offset 0xC0000000 -range 0x20000000 -target_address_space [get_bd_addr_spaces aiml_stub_0/Data_m_axi_data_mem] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP0/HPC0_QSPI]

  # Perform GUI Layout
  regenerate_bd_layout -layout_string {
   "ActiveEmotionalView":"Default View",
   "Default View_ScaleFactor":"1.25",
   "Default View_TopLeft":"-49,-243",
   "ExpandedHierarchyInLayout":"",
   "guistr":"# # String gsaved with Nlview 7.0r6  2020-01-29 bk=1.5227 VDI=41 GEI=36 GUI=JA:9.0 non-TLS
#  -string -flagsOSRD
preplace inst aiml_stub_0 -pg 1 -lvl 2 -x 680 -y 300 -defaultsOSRD
preplace inst axi_smc -pg 1 -lvl 3 -x 1120 -y 310 -defaultsOSRD
preplace inst proc_sys_reset_0 -pg 1 -lvl 1 -x 200 -y 110 -defaultsOSRD
preplace inst smartconnect_0 -pg 1 -lvl 3 -x 1120 -y 100 -defaultsOSRD
preplace inst zynq_ultra_ps_e_0 -pg 1 -lvl 2 -x 680 -y 100 -defaultsOSRD
preplace netloc proc_sys_reset_0_peripheral_aresetn 1 1 2 370 190 990
preplace netloc zynq_ultra_ps_e_0_pl_clk0 1 0 3 30 210 380J 220 980
preplace netloc zynq_ultra_ps_e_0_pl_resetn0 1 0 3 20 10 NJ 10 970
preplace netloc axi_smc_M00_AXI 1 1 3 390 200 NJ 200 1250
preplace netloc aiml_stub_0_m_axi_data_mem 1 2 1 N 290
preplace netloc smartconnect_0_M00_AXI 1 1 3 390 210 NJ 210 1260
preplace netloc zynq_ultra_ps_e_0_M_AXI_HPM0_FPD 1 2 1 N 80
levelinfo -pg 1 0 200 680 1120 1280
pagesize -pg 1 -db -bbox -sgen 0 0 1280 390
"
}

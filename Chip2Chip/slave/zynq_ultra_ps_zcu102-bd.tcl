...
proc cr_bd_$::_xil_proj_name_ { parentCell } {
  ...
  connect_bd_intf_net -intf_net LEDSupervisor_0_m_axi_status [get_bd_intf_pins LEDSupervisor_0/m_axi_status] [get_bd_intf_pins axi_smc_1/S01_AXI]
  connect_bd_intf_net -intf_net aiml_stub_0_m_axi_data_mem [get_bd_intf_pins aiml_stub_0/m_axi_data_mem] [get_bd_intf_pins axi_smc_1/S00_AXI]
  ...
  connect_bd_intf_net -intf_net axi_smc_1_M00_AXI [get_bd_intf_pins axi_chip2chip_0/s_axi_lite] [get_bd_intf_pins axi_smc_1/M00_AXI]
  connect_bd_intf_net -intf_net sensorSupervisor_0_m_axi_status [get_bd_intf_pins axi_smc_1/S02_AXI] [get_bd_intf_pins sensorSupervisor_0/m_axi_status]
  ...
  connect_bd_net -net clk_wiz_0_clk_out3 [get_bd_pins LEDSupervisor_0/ap_clk] [get_bd_pins aiml_stub_0/ap_clk] [get_bd_pins axi_chip2chip_0/m_aclk] [get_bd_pins axi_chip2chip_0/s_axi_lite_aclk] [get_bd_pins axi_smc_1/aclk] [get_bd_pins clk_wiz_0/clk_out3] [get_bd_pins proc_sys_reset_0/slowest_sync_clk] [get_bd_pins sensorSupervisor_0/ap_clk] [get_bd_pins smartconnect_0/aclk] [get_bd_pins smartconnect_0/aclk1]
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins LEDSupervisor_0/ap_rst_n] [get_bd_pins aiml_stub_0/ap_rst_n] [get_bd_pins axi_chip2chip_0/m_aresetn] [get_bd_pins axi_smc_1/aresetn] [get_bd_pins proc_sys_reset_0/peripheral_aresetn] [get_bd_pins sensorSupervisor_0/ap_rst_n] [get_bd_pins smartconnect_0/aresetn]
  connect_bd_net -net reset_1 [get_bd_ports reset] [get_bd_pins proc_sys_reset_0/ext_reset_in]

  # Create address segments
  assign_bd_address -offset 0x44A00000 -range 0x00010000 -target_address_space [get_bd_addr_spaces axi_chip2chip_0/MAXI] [get_bd_addr_segs LEDSupervisor_0/s_axi_cfg/Reg] -force
  assign_bd_address -offset 0x44A10000 -range 0x00010000 -target_address_space [get_bd_addr_spaces axi_chip2chip_0/MAXI] [get_bd_addr_segs aiml_stub_0/s_axi_cfg_port1/Reg] -force
  assign_bd_address -offset 0x44A20000 -range 0x00010000 -target_address_space [get_bd_addr_spaces axi_chip2chip_0/MAXI] [get_bd_addr_segs aiml_stub_0/s_axi_cfg_port2/Reg] -force
  assign_bd_address -offset 0x44A30000 -range 0x00010000 -target_address_space [get_bd_addr_spaces axi_chip2chip_0/MAXI] [get_bd_addr_segs sensorSupervisor_0/s_axi_cfg/Reg] -force

  # Exclude Address Segments
  exclude_bd_addr_seg -offset 0x80000000 -range 0x00010000 -target_address_space [get_bd_addr_spaces LEDSupervisor_0/Data_m_axi_status] [get_bd_addr_segs axi_chip2chip_0/s_axi_lite/Reg]
  exclude_bd_addr_seg -offset 0x80000000 -range 0x00010000 -target_address_space [get_bd_addr_spaces aiml_stub_0/Data_m_axi_data_mem] [get_bd_addr_segs axi_chip2chip_0/s_axi_lite/Reg]
  exclude_bd_addr_seg -offset 0x80000000 -range 0x00010000 -target_address_space [get_bd_addr_spaces sensorSupervisor_0/Data_m_axi_status] [get_bd_addr_segs axi_chip2chip_0/s_axi_lite/Reg]
...
#  -string -flagsOSRD
preplace port CLK_IN1_D_0 -pg 1 -lvl 0 -x -10 -y 460 -defaultsOSRD
preplace port port-id_GPIO_LED_0 -pg 1 -lvl 7 -x 2160 -y 670 -defaultsOSRD
preplace port port-id_GPIO_LED_1 -pg 1 -lvl 7 -x 2160 -y 690 -defaultsOSRD
preplace port port-id_axi_c2c_selio_rx_diff_clk_in_n_0 -pg 1 -lvl 0 -x -10 -y 700 -defaultsOSRD
preplace port port-id_axi_c2c_selio_rx_diff_clk_in_p_0 -pg 1 -lvl 0 -x -10 -y 670 -defaultsOSRD
preplace port port-id_axi_c2c_selio_tx_diff_clk_out_n_0 -pg 1 -lvl 7 -x 2160 -y 650 -defaultsOSRD
preplace port port-id_axi_c2c_selio_tx_diff_clk_out_p_0 -pg 1 -lvl 7 -x 2160 -y 570 -defaultsOSRD
preplace port port-id_reset -pg 1 -lvl 0 -x -10 -y 120 -defaultsOSRD
preplace portBus axi_c2c_selio_rx_data_in_0 -pg 1 -lvl 0 -x -10 -y 640 -defaultsOSRD
preplace portBus axi_c2c_selio_tx_data_out_0 -pg 1 -lvl 7 -x 2160 -y 590 -defaultsOSRD
preplace inst LEDSupervisor_0 -pg 1 -lvl 4 -x 1130 -y 80 -defaultsOSRD
preplace inst aiml_stub_0 -pg 1 -lvl 4 -x 1130 -y 230 -defaultsOSRD
preplace inst axi_chip2chip_0 -pg 1 -lvl 6 -x 1880 -y 630 -defaultsOSRD
preplace inst axi_smc_1 -pg 1 -lvl 5 -x 1480 -y 380 -defaultsOSRD
preplace inst clk_wiz_0 -pg 1 -lvl 1 -x 130 -y 460 -defaultsOSRD
preplace inst proc_sys_reset_0 -pg 1 -lvl 2 -x 430 -y 140 -defaultsOSRD
preplace inst sensorSupervisor_0 -pg 1 -lvl 4 -x 1130 -y 380 -defaultsOSRD
preplace inst smartconnect_0 -pg 1 -lvl 3 -x 770 -y 230 -defaultsOSRD
preplace netloc axi_c2c_selio_rx_data_in_1 1 0 6 NJ 640 NJ 640 NJ 640 NJ 640 NJ 640 1620J
preplace netloc axi_c2c_selio_rx_diff_clk_in_n_1 1 0 6 NJ 700 NJ 700 NJ 700 NJ 700 NJ 700 1640J
preplace netloc axi_c2c_selio_rx_diff_clk_in_p_1 1 0 6 NJ 670 NJ 670 NJ 670 NJ 670 NJ 670 NJ
preplace netloc axi_chip2chip_0_axi_c2c_link_status_out 1 6 1 NJ 670
preplace netloc axi_chip2chip_0_axi_c2c_multi_bit_error_out 1 6 1 NJ 690
preplace netloc axi_chip2chip_0_axi_c2c_selio_tx_data_out 1 6 1 2140J 590n
preplace netloc axi_chip2chip_0_axi_c2c_selio_tx_diff_clk_out_n 1 6 1 NJ 650
preplace netloc axi_chip2chip_0_axi_c2c_selio_tx_diff_clk_out_p 1 6 1 2130J 570n
preplace netloc clk_wiz_0_clk_out2 1 1 5 NJ 460 NJ 460 910J 600 NJ 600 1620
preplace netloc clk_wiz_0_clk_out3 1 1 5 250 240 620 320 920 460 1330 610 1630
preplace netloc proc_sys_reset_0_peripheral_aresetn 1 2 4 610 140 930 470 1340 590 NJ
preplace netloc reset_1 1 0 2 NJ 120 NJ
preplace netloc CLK_IN1_D_0_1 1 0 1 NJ 460
preplace netloc LEDSupervisor_0_m_axi_status 1 4 1 1340 80n
preplace netloc aiml_stub_0_m_axi_data_mem 1 4 1 1330 230n
preplace netloc axi_chip2chip_0_m_axi 1 2 5 630 480 NJ 480 NJ 480 NJ 480 2120
preplace netloc axi_smc_1_M00_AXI 1 5 1 1620 380n
preplace netloc sensorSupervisor_0_m_axi_status 1 4 1 N 380
preplace netloc smartconnect_0_M00_AXI 1 3 1 N 200
preplace netloc smartconnect_0_M01_AXI 1 3 1 N 220
preplace netloc smartconnect_0_M02_AXI 1 3 1 910 60n
preplace netloc smartconnect_0_M03_AXI 1 3 1 910 260n
levelinfo -pg 1 -10 130 430 770 1130 1480 1880 2160
pagesize -pg 1 -db -bbox -sgen -300 0 2460 770
",
   "Color Coded_ScaleFactor":"1.17927",
   "Color Coded_TopLeft":"-293,160",
